...
export default function CTA() {
  ...
  return (
    <section id="cta" className="section bg-paper-depth">
      <div className="max-w-layout mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {profiles.map((profile, index) => (
            <motion.div
              key={profile.key}
              className="p-8 rounded-2xl bg-gradient-to-b from-paper-depth to-transparent border border-border text-center"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              ...
              <p className="text-ink-secondary mb-6">{t(`${profile.key}_desc`)}</p>
