...
export const researchPapers: ResearchPaper[] = [
  {
    ...
    subtitle: 'Des conditions de viabilite de la cooperation multi-niveaux a la necessite structurelle du droit de sortie',
    authors: [
    ...
    tags: ['ThP', 'autopoiese', 'viabilite', 'exit', 'cooperation multi-niveaux', 'theorie des categories'],
    ...
    audits: [
      {
        ...
        slug: 'gemini-review',
        label: 'Audit Gemini',
        verdict: 'Transforme le libertarianisme radical en exigence de sante cybernetique.',
      ...
      },
      {
        ...
        verdict: 'Contribution authentique — conjecture structuree de haute qualite.',
  ...
  },
  {
    ...
    status: 'submitted',
    discipline: 'Biologie theorique',
    tags: ['theorie des categories', 'viabilite', 'systemes (M,R)', 'autopoiese', 'Rosen', 'sketch categoriel'],
    ...
    audits: [
      {
        ...
        slug: 'peter-g-review',
        label: 'Audit Peter G',
        verdict: 'Formalisation categorielle authentique et non-triviale d\'un invariant de viabilite.',
